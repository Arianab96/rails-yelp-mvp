...
min_jiang = { name: 'Min Jiang', address: '24 Kensington High St, London W8 4PT', phone_number: '02073611988', category: 'chinese' }

[da_mario, sumi, gold_mine, balthazar, min_jiang].each do |attributes|
